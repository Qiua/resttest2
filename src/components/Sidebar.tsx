  ...
  if (!isOpen) {
    return (
      <div className="w-12 bg-gray-800 dark:bg-gray-900 flex flex-col items-center py-3 gap-2 transition-all duration-300 ease-in-out">
        ...
        <button
          onClick={onToggle}
          className="text-white hover:bg-gray-700 dark:hover:bg-gray-800 p-2 rounded-md transition-colors duration-200 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
    ...
    <div className="w-80 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col h-full transition-all duration-300 ease-in-out">
      ...
      <div className="p-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            onClick={onToggle}
            className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        ...
        <div className="border-t border-gray-200 dark:border-gray-600 pt-3">
          ...
          <button
            onClick={onWorkspacePanelToggle}
            className={`w-full px-3 py-3 text-left text-sm font-medium rounded-lg transition-colors flex items-center gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
              isWorkspacePanelOpen
          ...
          <button
            onClick={onManageEnvironments}
            className="w-full px-3 py-3 text-left text-sm font-medium rounded-lg transition-colors flex items-center gap-3 mt-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
            <FiLayers className="w-5 h-5" />
            <div className="flex-1">
